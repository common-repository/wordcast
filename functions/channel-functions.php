<?php
	...
	function return_mime_type($media_file){
		$media_file_extension = strtolower(pathinfo($media_file, PATHINFO_EXTENSION));
			
		if($media_file_extension === 'mp4'){
			return 'video/mp4';
		} elseif($media_file_extension === 'mp3') {
			return 'audio/mpeg';
		} elseif($media_file_extension === 'm4a'){
